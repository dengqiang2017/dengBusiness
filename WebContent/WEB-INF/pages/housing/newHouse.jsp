...
<div>
<span style="font-size: 16px;"><a href="/login/index.do">首页</a>->新房</span>
</div>
<div style="height: 300px;">
<%@include file="query.jsp" %>
<div  id="newHouseList" style="border:1px solid #000;overflow-x: auto;width: auto;">
<table id="newHouseListGridInfo"></table>
<div id="newHouseListGridInfoPage"></div>
</div>
</div>