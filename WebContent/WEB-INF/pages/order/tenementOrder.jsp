...
<script src='/js/tenementOrder.js'></script>
<!-- <script src='/js/useredit.js?ver=001'></script> -->
<style>
<!--
...
<span>1.填写订单</span>&emsp;>&emsp;<span style="color: rgb(197,197,197);" id="orderCompleteTitle">2.完成</span>
</div>
...
<li><span>&ensp;初始月租:</span><font style="color: red;">${requestScope.housingInfo.monthlyRent}元</font></li>
<li><span>&emsp;&emsp;&ensp;租期:</span><input name="tenancy" maxlength="20"></li>
<li><span>&ensp;实际月租:</span><input maxlength="10" style="color: red;" name="actualMonthlyRent" value="${requestScope.housingInfo.monthlyRent}">元</li>
<li><span>&ensp;租客名称:</span>
<a class="imgFileA" id="selectUser">选择客户</a>
<span id="userinfo"></span>
<input type="hidden" name="client.id" id="homeownerId">
</li>
...
<input type="file" name="imgFile" id="imgFile" class="imgFile" onchange="imageUpload(this);" accept="">
<span id="msg"></span>
</span>
</li>
<li>
