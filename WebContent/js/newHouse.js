$(function(){
	var newHouseGridInfo=$("#tenementListGridInfo");
	newHouseGridInfo.jqGrid({
		url : "/housingInfo/queryhousing.do?type=2&math="+Math.random(),
		datatype : 'json',
		mtype : 'get',
		loadComplete : function(data,response){
			var totalPage =newHouseGridInfo.getGridParam("lastpage");
		...
		colNames : ["序号","区县","板块","小区","户型","楼层","面积(㎡)","单价","总价","房东","发布时间","修改时间","状态","备注"],
		colModel : [
		            ...
		            {name : "floor",index : "floor",editable : true,width:110} ,
...
//		            {name : "acreage",index : "acreage",editable : true,width:160} ,
//		            {name : "unitPrice",index : "unitPrice",editable : true,width:160} ,
//		            {name : "totalPrice",index : "totalPrice",editable : true,width:160} ,
//		            {name : "decorationType",index : "decorationType",editable : true,width:160,formatter:function(data){return data.name;}} ,
...
//		            {name : "housingType",index : "housingType",editable : true,width:160,formatter:function(data){return data.name;}} ,
...
//		            {name : "number",index : "number",editable : true,width:160},
